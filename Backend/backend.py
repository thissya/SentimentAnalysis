...
with open('E:/BDA Mini/Backend/ml model/logistic_regression_model.pkl', 'rb') as model_file:
    model = pickle.load(model_file)
    print("\nModel loaded successfully:", model)

with open('E:/BDA Mini/Backend/ml model/tfidf_vectorizer.pkl', 'rb') as vectorizer_file:
